...
//Put Here Your Postgres Password
const DEFAULT_DATABASE_PASSWORD: &'static str ="postgresql";
//const DEFAULT_DATABASE_URL: &'static str = "postgresql://postgres:admin@localhost:5432/messages";

fn connect_to_db() -> Option<PgConnection> {
    let database_url = env::var("DATABASE_URL").unwrap_or(String::from(  format!("postgresql://postgres:{}@localhost:5432/messages",DEFAULT_DATABASE_PASSWORD )));
